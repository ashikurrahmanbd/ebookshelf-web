            ...
            <div className="container mx-auto px-4 sm:px-0 w-full">
                <div className="recommended-books-elements">
                    ...
                    <div className="md:flex w-full gap-4">
                        <div className="fetaured-book md:basis-8/12 lg:basis-7/12 w-full mb-4 md:mb-0 flex-shrink-0">

                            <FeaturedBook />

                        </div>
                        <div className="right-side-recommended-books grid grid-cols-2 md:basis-4/12 lg:basis-5/12 md:flex gap-2 text-white flex-shrink-0">
                    ...
                    <div className="more-recommended-books">
                        <div className="mt-[40px] text-white gap-6 grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5">
